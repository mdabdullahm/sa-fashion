...
const BrandsGrid = () => {
  ...
  const brandsData = [
    ...
    { id: 6, name: "h&m-sweden", 
      logo: "https://i.ibb.co.com/whd0jtc0/Chat-GPT-Image-Aug-11-2026-09-57-36-AM.png" },
    { id: 7, name: "george", 
      logo: "https://i.ibb.co.com/7d6wmCh7/Chat-GPT-Image-Aug-11-2026-12-06-27-PM.png" },
    { id: 8, name: "sainsbury-uk", 
      logo: "https://i.ibb.co.com/jkjB7NRQ/llldownload.png" },
    { id: 9, name: "zara-spain", 
      logo: "https://i.ibb.co.com/Q7smsvZ6/images-removebg-preview.png" },
    { id: 10, name: "o'stin-russia", 
      logo: "https://i.ibb.co.com/JRZcvGn1/images-removebg-preview.png" },
